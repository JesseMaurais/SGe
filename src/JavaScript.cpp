...
namespace
{
	...
	template <typename Object> class NativeInfo : jerry_object_native_info_t
	{
	public:
		...
		jerry_value_t CreateObject(Object *object)
		{
		...
		void SetObject(jerry_value_t const obj, Object *object)
		{
			Pointer cast;
			cast.object = object;
		...
		Object *GetObject(jerry_value_t const obj)
		{
			Pointer cast;
