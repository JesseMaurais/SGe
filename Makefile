...
ALL = Bezier.o BSP.o Crayon.o Desktop.o Event.o File.o FreeType.o Hedron.o JavaScript.o main.o Matrix.o Mesh.o Model.o Nurbs.o OpenAL.o OpenCL.o OpenGL.o Plane.o Quaternion.o SDL.o Shader.o Signal.o Stream.o Strings.o Stroke.o Surface.o Tessel.o Tree.o Vector.o XML.o
OBJDIR = obj/
SRCDIR = src/
PCH = $(SRCDIR)main.hpp
